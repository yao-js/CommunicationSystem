package com.yjs.communicationsystem.fabricUtil;/*
...
public class RegisterFabricUser {
	...
	public static void main(String[] args) throws Exception {
		...
		HFCAClient caClient = HFCAClient.createNewInstance("https://47.243.43.241:7054", props);
