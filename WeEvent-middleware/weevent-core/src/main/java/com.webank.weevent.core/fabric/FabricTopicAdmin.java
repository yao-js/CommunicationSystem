...
public class FabricTopicAdmin implements IEventTopic {
    ...
    public List<Pair<String, String>> getContractInfo(String channelName) throws BrokerException, InvalidArgumentException, ProposalException {
        List<Pair<String, String>> chaincodeList = fabricDelegate.getContractContext(channelName);
