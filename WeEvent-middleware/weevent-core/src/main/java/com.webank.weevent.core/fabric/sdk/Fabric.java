...
import com.webank.weevent.core.dto.*;
import com.webank.weevent.core.fabric.dto.TransactionInfo;
...
public class Fabric {
    ...
    public void init(String channelName) throws BrokerException {
        try {
            ...
            topicChaincodeID = FabricSDKWrapper.getChainCodeID(fabricConfig.getTopicName(), fabricConfig.getTopicVerison());
        } catch (Exception e) {
    ...
    public TopicInfo getTopicInfo(String topicName) throws BrokerException {
        ...
        try {
            TransactionInfo transactionInfo = FabricSDKWrapper.executeTransaction(hfClient, channel, topicControllerChaincodeID, true,
    ...
    public List<Pair<String, String>> getContractContext(FabricConfig fabricConfig) throws InvalidArgumentException, ProposalException {
        List<Pair<String, String>> chainCodeList = new ArrayList<>();
        Peer peer0 = FabricSDKWrapper.getPeer(hfClient, fabricConfig);
        chainCodeList = FabricSDKWrapper.queryInstalledChaincodes(hfClient, peer0);
