...
public class FabricDelegate {
    ...
    public List<Pair<String, String>> getContractContext(String channelName) throws ProposalException, InvalidArgumentException {
        return this.fabricMap.get(channelName).getContractContext(this.fabricConfig);
    }
