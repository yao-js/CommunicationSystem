...
public class BrokerStomp extends TextWebSocketHandler {
    ...
    @Autowired
    public void setProducer(@Qualifier("fabricIProducer") IProducer producer) {
        this.iproducer = producer;
    }

    @Autowired
    public void setConsumer(@Qualifier("fabricIConsumer") IConsumer consumer) {
...
//        log.error("User : " + stompHeaderAccessor.getUser());
//        log.error("authAccount : " + this.authAccount + " " + "authPassword : " + this.authPassword);
//        log.error("login : " +stompHeaderAccessor.getLogin()+ " " + "passcode : " + stompHeaderAccessor.getPasscode());
//        log.error(String.valueOf(this.authAccount.equals(stompHeaderAccessor.getLogin() + " " + this.authPassword.equals(stompHeaderAccessor.getPasscode() + " " + stompHeaderAccessor.getUser()))));
