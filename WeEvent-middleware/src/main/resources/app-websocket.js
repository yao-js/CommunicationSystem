...
/* 进行连接 */
function connect() {
    // let socketUrl = "ws://127.0.0.1:5003/middleware/service/" + "subscribe";
    let socketUrl = "ws://127.0.0.1:5003/middleware/service/publish/" + "yjs";

    socket = new WebSocket(socketUrl);
    socket.onopen = function() {
        console.log("websocket 已打开 userId: " );
    };
    // // 设置 SOCKET
